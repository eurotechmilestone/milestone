...
const BreadCrumb = () => {
  ...
  return (
    <div className=" relative font-fredoka h-[320px]  md:h-[300px]">
      ...
      <div className="absolute inset-0 flex justify-center items-center flex-col h-[200px] space-y-8 mt-5  z-20  w-4/5 lg:w-3/4 mx-auto  animate-bounce1">
        <div className=" ms-auto"><img src="./image/curved-line-2.png" alt="whiteCurved" className="w-16 "/></div>
        <div className="me-auto "><img src="./image/white-curved-line.png" alt="whiteCurved" className="w-14  mt-5 " /></div>
